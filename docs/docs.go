            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.BooksListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UserOrdersResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UserOrderDetailsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.DeleteProfileRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request / wrong password / active orders exist",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "dto.AdminOrderResponse": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AdminOrderItemResponse"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "dto.AdminOrdersResponse": {
            ...
            "properties": {
                "orders": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AdminOrderListItemResponse"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "dto.BooksListResponse": {
            ...
            "properties": {
                "books": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.BookListItemResponse"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "dto.UserOrderDetailsResponse": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.UserOrderDetailsItemResponse"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "dto.UserOrdersResponse": {
            ...
            "properties": {
                "orders": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.UserOrderListItemResponse"
                    }
                },
                "page": {
                    "type": "integer"
